...
public class DesignatorStatement_funcitionCall extends DesignatorStatement {

    private Designator Designator;
    private ActParsList ActParsList;

    public DesignatorStatement_funcitionCall (Designator Designator, ActParsList ActParsList) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("DesignatorStatement_funcitionCall(\n");
