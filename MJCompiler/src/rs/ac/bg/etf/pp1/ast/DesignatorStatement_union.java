...
public class DesignatorStatement_union extends DesignatorStatement {

    private Designator Designator;
    private Designator Designator1;
    private Designator Designator2;

    public DesignatorStatement_union (Designator Designator, Designator Designator1, Designator Designator2) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("DesignatorStatement_union(\n");
